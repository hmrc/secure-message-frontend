...
object NameCase {
  ...
  val POST_NOMINAL_INITIALS: Seq[String] = Seq(
    "VC",
    "GC",
    "KG",
    "LG",
  ...
  val firstLetters: Regex = raw"\b(\w)".r // # Uppercase first letter of every word.
  val quoteS: Regex = raw"'(\w)\b".r // # Uppercase first letter of every word.
